                ...
                {!isCollapsed ? (
                    <>
                        ...
                        <button
                            ...
                            className="w-full p-3 flex items-center justify-between text-sm text-gray-400 hover:text-white hover:bg-gray-800/50 transition-colors"
                        >
                            <span className="font-medium">Quick Actions</span>
                            <ChevronsRight className={`w-4 h-4 transition-transform ${isFooterCollapsed ? '' : 'rotate-90'}`} />
                        </button>
